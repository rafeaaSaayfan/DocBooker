...
<body class="@if (App::isLocale('ar')) rtl @endif relative">
                ...
                <div id="calendar">
                    <div class="days rounded-xl h-screen bg-transparent p-2 md:p-5">
                        <div class="search pb-5">
                            ...
                            <div class="grid grid-cols-4 md:grid-cols-7 gap-2 border-none rounded-md text-sm md:text-base">
                                <input type="number" step="1" min="2023" placeholder="{{ __('messages.year') }}" id="yearSearch" class="col-span-1 md:col-span-2 bg-gray-100 px-4 py-2 border-0 w-full outline-green-500 hover:outline-green-500 border-none rounded-md">
                                <input type="number" step="1" min="1" max="12" placeholder="{{ __('messages.month') }}" id="monthSearch" class="col-span-1 md:col-span-2 bg-gray-100 px-4 py-2 border-x-2 w-full outline-green-500 hover:outline-green-500 border-none rounded-md">
                                <input type="number" step="1" min="1" max="31" placeholder="{{ __('messages.day') }}" id="daySearch" class="col-span-1 md:col-span-2 bg-gray-100 px-4 py-2 border-0 w-full outline-green-500 hover:outline-green-500 border-none rounded-md">
                                <button class="col-span-1 flex items-center justify-center gap-1 border-none rounded-md bg-blue-400 hover:bg-blue-500 text-white @if (App::isLocale('ar')) rounded-l-md @endif @if (App::isLocale('en')) rounded-r-md @endif" id="searchBtn">
                    ...
                    <div onclick="document.getElementById('modalForMake').classList.remove('hidden'); document.getElementById('modalForMake').classList.add('flex')" class="makeAppointment fixed p-2 cursor-pointer bottom-5 @if (App::isLocale('en')) right-5 @endif @if (App::isLocale('ar')) left-5 @endif bg-blue-500 hover:bg-blue-800 rounded-full">
                        <svg width="35" class="fill-white" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <circle cx="130.8293" cy="215.7292" r="16.4529" />
                            <circle cx="316.7671" cy="215.7292" r="16.4529" />
    ...
    <div id="modalForMake" class="absolute inset-0 top-0 left-0 w-full h-full hidden items-center justify-center bg-black/70 backdrop-blur z-20">
        <div class="md:w-1/2 w-full relative bg-gray-300 rounded-xl shadow mb-15 mx-3 md:mx-0">
            <div onclick="document.getElementById('modalForMake').classList.remove('flex'); document.getElementById('modalForMake').classList.add('hidden')" class="absolute top-4 @if (App::isLocale('en')) right-4 @endif @if (App::isLocale('ar')) left-4 @endif cursor-pointer">
            ...
            <div class="pt-5 pb-5 w-full px-4">
