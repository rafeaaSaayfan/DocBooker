    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 my-5">
        ...
        <dialog id="editModal" class="w-full md:w-1/2 xl:w-1/3 bg-white rounded-xl shadow">
        ...
        <dialog id="deletModal" class="w-full md:w-1/2 xl:w-1/3 bg-gray-100 rounded-xl shadow">
            <div class="w-full relative">
