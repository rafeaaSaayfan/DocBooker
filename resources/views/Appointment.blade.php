    ...
    <div id="calendar">
        <div class="days rounded-xl bg-transparent p-1">
            <div class="search pb-5">
                ...
                <div class="grid grid-cols-4 md:grid-cols-7 gap-2 rounded-md text-sm md:text-base ">
                    <input type="number" step="1" min="2023" placeholder="{{ __('messages.year') }}" id="yearSearch" 
                    class="col-span-1 md:col-span-2 bg-gray-100 px-4 py-2 border-0 w-full outline-green-500 hover:outline-green-500 border-none rounded-md">
                    <input type="number" step="1" min="1" max="12" placeholder="{{ __('messages.month') }}" id="monthSearch" 
                    class="col-span-1 md:col-span-2 bg-gray-100 px-4 py-2 border-x-2 w-full outline-green-500 hover:outline-green-500 border-none rounded-md">
                    <input type="number" step="1" min="1" max="31" placeholder="{{ __('messages.day') }}" id="daySearch" 
                    class="col-span-1 md:col-span-2 bg-gray-100 px-4 py-2 border-0 w-full outline-green-500 hover:outline-green-500 border-none rounded-md">
                    <button class="col-span-1 rounded-md flex items-center justify-center gap-1 bg-blue-400 hover:bg-blue-500 text-white @if (App::isLocale('ar')) rounded-l-md @endif @if (App::isLocale('en')) rounded-r-md @endif" id="searchBtn">
...
<script>
    ...
    li2.classList.add("active", "bg-green-500/50", "p-2", "rounded-md", "font-semibold");
